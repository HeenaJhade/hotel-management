...
import { Hotel, Menu, X, Wifi, Coffee, Car, Dumbbell, MapPin, Phone, Mail, Star, Shield, Clock } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      icon: Coffee,
      title: 'Fine Dining',
      description: 'Exquisite culinary experiences at our restaurant'
    },
    {
      icon: Car,
      title: 'Valet Parking',
    ...
    },
    {
      ...
      description: 'State-of-the-art gym equipment and facilities'
    },
    {
      icon: Clock,
      title: '24/7 Concierge',
      description: 'Dedicated staff to assist you anytime'
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#home" data-testid="nav-home" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">Home</a>
              <a href="#rooms" data-testid="nav-rooms" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">Rooms</a>
              <a href="#about" data-testid="nav-about" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">About</a>
              <a href="#contact" data-testid="nav-contact" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">Contact</a>
              <Link to="/login">
                <Button data-testid="nav-login-button" variant="outline" size="sm" className="rounded-lg">
                  Sign In
                </Button>
              </Link>
              <Link to="/signup">
                <Button data-testid="nav-signup-button" size="sm" className="bg-slate-900 hover:bg-slate-800 rounded-lg">
                  Sign Up
                </Button>
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-3">
              <a href="#home" className="block text-sm font-medium text-slate-600 hover:text-slate-900">Home</a>
              <a href="#rooms" className="block text-sm font-medium text-slate-600 hover:text-slate-900">Rooms</a>
              <a href="#about" className="block text-sm font-medium text-slate-600 hover:text-slate-900">About</a>
              <a href="#contact" className="block text-sm font-medium text-slate-600 hover:text-slate-900">Contact</a>
              <div className="flex gap-2 pt-2">
                <Link to="/login" className="flex-1">
                  <Button variant="outline" className="w-full rounded-lg">Sign In</Button>
                </Link>
                <Link to="/signup" className="flex-1">
                  <Button className="w-full bg-slate-900 hover:bg-slate-800 rounded-lg">Sign Up</Button>
                </Link>
              </div>
            </div>
          </motion.div>
      ...
      {/* Hero Section */}
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16" data-testid="hero-section">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/signup">
                <Button data-testid="hero-book-button" size="lg" className="bg-[#C6A87C] hover:bg-[#B09265] text-white text-base px-8 py-6 rounded-lg">
                  Book Your Stay
                </Button>
              </Link>
              <a href="#rooms">
                <Button data-testid="hero-explore-button" size="lg" variant="outline" className="bg-white/10 backdrop-blur-sm text-white border-white hover:bg-white hover:text-slate-900 text-base px-8 py-6 rounded-lg">
                  Explore Rooms
                </Button>
              </a>
            </div>
      ...
      {/* Rooms Section */}
      <section id="rooms" className="py-24 bg-slate-50" data-testid="rooms-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/signup">
                      <Button data-testid={`book-room-${room.id}`} size="sm" className="bg-slate-900 hover:bg-slate-800 rounded-lg">
                        Book Now
                      </Button>
                    </Link>
                  </div>
      ...
      <section id="why-choose-us" className="py-24 bg-white" data-testid="why-choose-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
      ...
      <footer className="bg-slate-900 text-white py-12" data-testid="footer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-400">
            <p>&copy; 2026 HM Hotel. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
