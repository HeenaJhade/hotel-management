...
import {
  Sparkles, Calendar, Shield, Award,
  Hotel, Menu, X, Wifi, Coffee, Car, Dumbbell,
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                size="lg"
                className="bg-[#C6A87C] hover:bg-[#B09265] text-white text-base px-8 py-6 rounded-lg"
              ...
              <Button
                variant="outline"
                size="lg"
                className="bg-white/10 backdrop-blur-sm text-white border-white hover:bg-white hover:text-slate-900 text-base px-8 py-6 rounded-lg"
                asChild
              >
                <a href="#rooms" data-testid="hero-explore-button">
                  Explore Rooms
                </a>
              </Button>
            </div>
