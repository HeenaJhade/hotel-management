...
export default function AdminBookings() {
  ...
  const fetchBookings = useCallback(async () => {
    try {
      ...
      // Safety: correct page if out of bounds
      ...
      <div data-testid="admin-bookings-page" className="space-y-6 pb-10">
        ...
        {error ? (
          ...
          <div className="text-center py-12 text-slate-500">
            {searchTerm
              ? 'No bookings match your search on this page.'
              : 'No bookings found.'}
          </div>
        ) : viewMode === "grid" ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredBookings.map((booking) => (
              <Card
                ...
                className="group border border-slate-200 hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden"
              >
                <CardContent className="p-6 space-y-5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`px-3 py-1 text-xs rounded-full border ${getPaymentStatusColor(
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-slate-50 p-6 rounded-xl">
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-flex px-3 py-1 text-xs font-medium rounded-full border ${getStatusColor(selectedBooking.status)}`}
                      >
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-flex px-3 py-1 text-xs font-medium rounded-full border ${getPaymentStatusColor(selectedBooking.paymentStatus)}`}
                      >
