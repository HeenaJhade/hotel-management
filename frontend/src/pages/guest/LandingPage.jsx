    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              <div className="flex gap-2 pt-2">
                <Link to="/login" className="flex-1">
                  <button className="w-full px-4 py-2.5 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors">
                    Sign In
                  </button>
                </Link>
                <Link to="/signup" className="flex-1">
                  <button className="w-full px-4 py-2.5 bg-slate-900 text-white hover:bg-slate-800 rounded-lg transition-colors">
                    Sign Up
                  </button>
                </Link>
              </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16" data-testid="hero-section">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-b from-slate-900/40 to-slate-900/80"></div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="#rooms">
                <button
                  ...
                  className="px-8 py-6 text-base font-medium bg-white/10 backdrop-blur-sm text-white border border-white hover:bg-white hover:text-slate-900 rounded-lg transition-colors"
                >
                  Explore Rooms
                </button>
              </a>
      ...
      <footer className="bg-slate-900 text-white py-12" data-testid="footer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-400">
            <p>© 2026 HM Hotel. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
